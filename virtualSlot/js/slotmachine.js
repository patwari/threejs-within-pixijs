function virtualSlotMachine(canvas) {
  'use strict';
  ...
  var startButtonTexture = THREE.ImageUtils.loadTexture("virtualSlot/images/start.png");
  ...
  function onDocumentMouseDown(event) {
    ...
    var intersects = raycaster.intersectObjects([startButton], true);
